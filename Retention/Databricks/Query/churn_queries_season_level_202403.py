...
CREATE OR REPLACE TABLE bolt_cus_dev.bronze.cip_churn_user_stream60d_genpop_20231201 AS (
with subs as(
...
and cycle_expire_date between '2023-12-01' and '2023-12-31'
--LIMIT 3000000
)
...
where DATEDIFF(DAY, hb.request_date_pst, ss.cycle_expire_date) <= 60
    and hb.request_date_pst between '2023-10-01' and '2023-12-31'
