...
qry = '''
        ...
        WHERE END_DATE <= LEAST('{end_date}', '2023-05-23')
        and START_DATE = '{start_date}'
        --and MOD(DATEDIFF('DAY', dt.start_date::DATE, dt.end_date::DATE), 7) = 0
        AND DATEDIFF('DAY', dt.start_date::DATE, dt.end_date::DATE) = 60
        GROUP BY 1,2,3
        
'''

table = 'user_title_hours_watched_subs'
t =  pd.to_datetime('2023-03-01')
